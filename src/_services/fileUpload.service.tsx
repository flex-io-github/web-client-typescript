...
function getAll() {
    ...
    return fetch(config.apiUrl + '/FileManager', requestOptions).then(handleResponse, handleError);
}
...
function _delete(id: any) {
    ...
    return fetch(config.apiUrl + '/FileManager/' + id, requestOptions).then(handleResponse, handleError);
}
